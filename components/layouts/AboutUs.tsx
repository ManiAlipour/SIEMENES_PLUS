      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-14 items-center px-6 md:px-10">
        ...
        <div className="order-2 md:order-1 text-right">
          ...
          <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
            زیمنس پلاس از سال ۱۳۹۷ در حوزه تأمین تجهیزات اتوماسیون صنعتی و
            راه‌اندازی خطوط تولید فعالیت دارد. تمرکز ما بر ارائه راهکارهای
            اختصاصی بر پایه تکنولوژی‌های زیمنس و ادغام سیستم‌های هوشمند در صنعت
            ایران است.
          </p>
