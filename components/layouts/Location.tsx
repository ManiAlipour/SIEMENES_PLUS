    ...
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="relative z-20">
          ...
          <div className="h-[3px] w-28 bg-gradient-to-r from-[#00A9E0] via-[#00CFB9] to-[#00A9E0] mb-6 rounded-full opacity-70"></div>
        ...
        <div className="relative rounded-[14px] overflow-hidden">
          ...
          {/* Top glow pulse */}
          <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-transparent via-[#00CFB9] to-transparent animate-pulse opacity-75 pointer-events-none"></div>

          {/* Grid overlay */}
          <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-[size:36px_36px] pointer-events-none rounded-[14px]"></div>
          ...
          <iframe
            ...
            className="relative z-10 w-full h-[360px] grayscale-[25%] hover:grayscale-0 transition-all duration-700 border border-[#004c97]/20 rounded-[14px]"
            allowFullScreen
            loading="lazy"
      ...
      <div
        aria-hidden="true"
        className="absolute bottom-0 left-0 right-0 h-[160px] bg-gradient-to-t from-[#004c97]/30 via-transparent to-transparent pointer-events-none"
      ></div>
    </section>
  );
}
