      ...
      >
        {({ touched, errors }) => (
          <Form className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">عنوان پیام</label>
              <Field
                type="text"
                name="title"
                required
            ...
            >
              {loading ? "در حال ارسال..." : (<> <Send className="w-5 h-5" /> ارسال پیام </>)}
            </motion.button>
          </Form>
        )}
      </Formik>
    ...
    <main className="min-h-screen font-vazir bg-gradient-to-br from-gray-50 via-white to-blue-50/30">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 pb-16">
        <motion.div
          ...
          className="bg-white rounded-3xl p-8 border-2 border-gray-200 shadow-xl"
        >
          <h3 className="text-2xl font-bold text-gray-900 mb-6">دفتر مرکزی Siemens Plus</h3>
